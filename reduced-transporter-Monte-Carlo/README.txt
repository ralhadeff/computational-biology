This MC program simulates a reduced model of a transporter, with discreet sites and a fixed number of ions.
...
An example input file is given for the ZnT2 transporter (publication currently under review)
